 ...
 * @Description RequestLockKeyGenerator
 * @Author travis-wei
 * @Version v1.0
 * @Data 2024/6/18
 */
public class RequestLockKeyGenerator {
    ...
    public static String getLockKey(ProceedingJoinPoint joinPoint) {
        ...
        for (int i = 0; i < parameters.length; i++) {
            final RequestLockKey keyParam = parameters[i].getAnnotation(RequestLockKey.class);
        ...
        if (StrUtil.isEmpty(sb.toString())) {
            ...
            for (int i = 0; i < parameterAnnotations.length; i++) {
                ...
                for (Field field : fields) {
                    ...
                    final RequestLockKey annotation = field.getAnnotation(RequestLockKey.class);
                    // 如果没有，跳过
                    if (annotation == null) {
                        continue;
                    }
