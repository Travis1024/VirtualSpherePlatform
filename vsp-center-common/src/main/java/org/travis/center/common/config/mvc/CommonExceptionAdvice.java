...
import org.travis.shared.common.utils.RequestInfoUtil;
...
public class CommonExceptionAdvice {
    ...
    public Object handleDubboRpcException(RpcException exception) {
        ...
        return processResponse(BizCodeEnum.DUBBO_CALL_ERROR.getCode(), BizCodeEnum.DUBBO_CALL_ERROR.getMessage() + StrUtil.COLON + exception.getMessage());
    }
    ...
    public Object handleRuntimeException(Exception exception) {
        ...
        return processResponse(BizCodeEnum.INTERNAL_SERVER_ERROR.getCode(), BizCodeEnum.INTERNAL_SERVER_ERROR.getMessage() + StrUtil.COLON + exception.getMessage());
    }
